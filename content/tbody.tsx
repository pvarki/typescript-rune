...
export const tbody : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <tbody className={prepareClassNameFn(context)}>{bodyFn(context)}</tbody>
}
