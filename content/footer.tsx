...
export const footer : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <footer className={prepareClassNameFn(context)}>{bodyFn(context)}</footer>
}
