...
export const span : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <span className={prepareClassNameFn(context)}>{bodyFn(context)}</span>
}
