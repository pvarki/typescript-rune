...
export const sub : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <sub className={prepareClassNameFn(context)}>{bodyFn(context)}</sub>
}
