...
export const main : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <main className={prepareClassNameFn(context)}>{bodyFn(context)}</main>
}
