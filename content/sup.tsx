...
export const sup : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <sup className={prepareClassNameFn(context)}>{bodyFn(context)}</sup>
}
