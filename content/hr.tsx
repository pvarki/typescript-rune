...
export const hr : RendererCompiler<BaseContent> = (content: BaseContent) : CompiledRenderer => {
  const prepareClassNameFn = ProductContentRenderer.prepareClassName(content.classes);
  return (context : RendererContext) => <hr className={prepareClassNameFn(context)} />
}
