...
export const tfoot : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <tfoot className={prepareClassNameFn(context)}>{bodyFn(context)}</tfoot>
}
