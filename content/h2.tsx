...
export const h2 : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <h2 className={prepareClassNameFn(context)}>{bodyFn(context)}</h2>
}
