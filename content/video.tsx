...
export const video : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <video className={prepareClassNameFn(context)}>{bodyFn(context)}</video>
}
