...
export const thead : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <thead className={prepareClassNameFn(context)}>{bodyFn(context)}</thead>
}
