...
export const nav : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <nav className={prepareClassNameFn(context)}>{bodyFn(context)}</nav>
}
