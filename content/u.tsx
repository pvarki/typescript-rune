...
export const u : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <u className={prepareClassNameFn(context)}>{bodyFn(context)}</u>
}
