...
export const em : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <em className={prepareClassNameFn(context)}>{bodyFn(context)}</em>
}
