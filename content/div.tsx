...
export const div : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <div className={prepareClassNameFn(context)}>{bodyFn(context)}</div>
}
