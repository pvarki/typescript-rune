...
export const article : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <article className={prepareClassNameFn(context)}>{bodyFn(context)}</article>
}
