...
export const tr : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <tr className={prepareClassNameFn(context)}>{bodyFn(context)}</tr>
}
