...
export const strong : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <strong className={prepareClassNameFn(context)}>{bodyFn(context)}</strong>
}
