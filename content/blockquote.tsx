...
export const blockquote : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <blockquote className={prepareClassNameFn(context)}>{bodyFn(context)}</blockquote>
}
