...
export const del : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <del className={prepareClassNameFn(context)}>{bodyFn(context)}</del>
}
