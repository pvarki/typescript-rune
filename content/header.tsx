...
export const header : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <header className={prepareClassNameFn(context)}>{bodyFn(context)}</header>
}
