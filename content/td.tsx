...
export const td : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <td className={prepareClassNameFn(context)}>{bodyFn(context)}</td>
}
