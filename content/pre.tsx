...
export const pre : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <pre className={prepareClassNameFn(context)}>{bodyFn(context)}</pre>
}
