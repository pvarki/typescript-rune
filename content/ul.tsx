...
export const ul : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <ul className={prepareClassNameFn(context)}>{bodyFn(context)}</ul>
}
