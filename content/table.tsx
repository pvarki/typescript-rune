...
export const table : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <table className={prepareClassNameFn(context)}>{bodyFn(context)}</table>
}
