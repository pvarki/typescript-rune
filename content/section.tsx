...
export const section : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <section className={prepareClassNameFn(context)}>{bodyFn(context)}</section>
}
