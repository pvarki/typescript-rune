...
export const th : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <th className={prepareClassNameFn(context)}>{bodyFn(context)}</th>
}
