...
export const li : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <li className={prepareClassNameFn(context)}>{bodyFn(context)}</li>
}
