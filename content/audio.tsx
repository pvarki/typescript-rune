...
export const audio : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <audio className={prepareClassNameFn(context)}>{bodyFn(context)}</audio>
}
