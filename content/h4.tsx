...
export const h4 : RendererCompiler<BaseContent> = (content: BaseParentContent) : CompiledRenderer => {
  ...
  return (context : RendererContext) => <h4 className={prepareClassNameFn(context)}>{bodyFn(context)}</h4>
}
